...
import ProductsPage from '@/app/(dashboard)/owner/product-master/page';
...
vi.mock('@/app/(dashboard)/owner/product-master/_components/product-filters', () => ({
  ProductFilters: () => <div>ProductFilters</div>
}));
vi.mock('@/app/(dashboard)/owner/product-master/_components/create-product-form', () => ({
  CreateProductForm: () => <div>CreateProductForm</div>
}));
vi.mock('@/app/(dashboard)/owner/product-master/_components/gs1-status-badge', () => ({
...
describe('Owner Product Master Page Access', () => {
  const mockSession = {
    user: {
      id: 'user1',
