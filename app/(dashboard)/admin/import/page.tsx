    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-admin-light dark:bg-admin/20">
          <Upload className="h-5 w-5 text-admin dark:text-admin" />
        </div>
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300">
            Import supplier catalogs via CSV. Products are matched by GTIN and enriched with GS1 data (Data Steward).
          </p>
        </div>
      </div>
      ...
      {suppliers.length === 0 ? (
        <div className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900/60 dark:shadow-none">
          ...
          <p className="mx-auto max-w-sm text-sm text-slate-500 dark:text-slate-400">
            ...
            Go to Admin &gt; Suppliers to add suppliers.
          </p>
        </div>
      ) : (
