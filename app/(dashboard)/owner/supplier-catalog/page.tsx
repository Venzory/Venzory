...
export default async function SupplierCatalogPage({ searchParams }: SupplierCatalogPageProps) {
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
              Supplier Catalog (Global)
            </h1>
            <p className="text-sm text-slate-600 dark:text-slate-300">
              Review and manage supplier offerings across the platform. Each row represents a supplier&apos;s offer
