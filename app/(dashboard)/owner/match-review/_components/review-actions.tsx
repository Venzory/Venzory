  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        disabled={isPending}
        className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-sky-700 bg-sky-50 rounded hover:bg-sky-100 dark:bg-sky-900/30 dark:text-sky-400 dark:hover:bg-sky-900/50 transition-colors disabled:opacity-50"
