    ...
    <div className="space-y-6">
      ...
      {isAdmin && (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-white">Practice Settings</h2>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-6">
            <form action={updatePracticeSettingsInlineAction} className="space-y-6">
              {/* Practice Name */}
              <div className="space-y-2">
                <label htmlFor="practice-name" className="text-sm font-medium text-slate-200">
                  Practice Name
                </label>
                <input
                  id="practice-name"
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2 sm:col-span-2">
                    <label htmlFor="street" className="text-sm font-medium text-slate-200">
                      Street
                    </label>
                    <input
                      id="street"
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contactPhone" className="text-sm font-medium text-slate-200">
                      Contact Phone
                    </label>
                    <input
                      id="contactPhone"
              ...
              {/* Logo */}
              <div className="space-y-2">
                <label htmlFor="logoUrl" className="text-sm font-medium text-slate-200">
                  Logo URL
                </label>
                <input
                  id="logoUrl"
                      ...
                      {isAdmin && membership.user.id !== session.user.id ? (
                        <form action={updateUserRoleInlineAction} className="inline">
                          ...
                          <select
                            ...
                            className="rounded-full border-0 px-2 py-1 text-xs font-medium focus:ring-2 focus:ring-sky-500/30 bg-slate-800 text-slate-200"
                          >
