...
export function ExpectedItemsForm({
  ...
  const [state, formAction] = useFormState(addReceiptLineAction, null);
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2.5 text-base text-slate-100 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/30"
                  autoFocus
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2.5 text-base text-slate-100 placeholder:text-slate-600 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500/30"
                />
              </div>
